...
#### planned features
- Changes to the comment field. Currently anyone can leave or delete a comment on the hairstylist page. My next change will be to amend this to allow only people who have logged on to leave and delete their own comments.
- Include an input field to include the name and email of the person who leaves a comment.
- Add a client user login and register allowing a restricted access to the site so they can leave the comments.  
